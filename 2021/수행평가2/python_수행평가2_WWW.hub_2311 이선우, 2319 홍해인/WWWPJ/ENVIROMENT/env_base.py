class Base:
    def envBase(self):
        # BACKMENU: 1.MAINMENU, 2.ENVIROMENT, 3.FINISH
        print('￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣')
        print('| 　BACKMENU!　　　　　　　　　　　　　　　   　　[－][口][×] |')
        print('| ￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣ |')
        print('| 　　　　＿＿＿＿＿＿　　　　＿＿＿＿＿＿　　　　＿＿＿＿＿　　　 |')
        print('| 　　　｜1.메인메뉴 | 　　｜2.환경메뉴 ｜ 　  |3.끝내기 | 　  |')
        print('| 　　　　￣￣￣￣￣￣　　　　￣￣￣￣￣￣　　　　￣￣￣￣￣　　　 |')
        print('￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣￣')
        ...
        if (menu == 1):
            ...
            import WWWPJ.ENVIROMENT.env_base              # ENVIROMENT 폴더 속 env_base 파일로 임폴트 하자
            show_menu = WWWPJ.ENVIROMENT.env_base.Base()  # env_base 파일에 Base 클래스에 들어가자
            show_menu.envBase()                           # Base 클래스에 envBase 함수를 보여주자