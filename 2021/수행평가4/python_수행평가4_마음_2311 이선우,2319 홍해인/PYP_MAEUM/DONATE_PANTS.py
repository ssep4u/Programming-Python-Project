...
class Pants_donate:
    def __init__(self, pants_donate):
        ...
        # 화면 이미지
        self.Pants_donateBack = tkinter.PhotoImage(file="img/donate_check_back.png")
        self.Pants_donateBackL = tkinter.Label(image=self.Pants_donateBack)
        self.Pants_donateBackL.place(x=-2, y=-2)

        # pantsEx 이미지
        self.pantsEx = tkinter.Button(self.pants_donate, width=210, height=205, borderwidth=0)
        self.pantsEx.place(x=150, y=200)
        self.pantsExImg = tkinter.PhotoImage(file="img/pants.png")
        self.pantsEx.config(image=self.pantsExImg)

        # 레이블 박스
        school = ["미림마이스터고", "선린인터넷고", "디지털미디어고"]  # 콤보 박스에 나타낼 항목 리스트
        combobox = ttk.Combobox(pants_donate)  # root라는 창에 콤보박스 생성
        ...
        # 레이블 박스 버튼
        btn = Button(pants_donate)  # cardigan_donate라는 창에 버튼 생성
        ...
        # 레이블 선택되었음 대기
        school_lb = Label(pants_donate)  # cardigan_donate라는 창에 레이블 생성
        school_lb.place(x=670, y=148)  # 레이블 배치

        # size 라디오
        size_lang_var = StringVar()  # str 형으로 변수 저장
        btn_size1 = Radiobutton(pants_donate, text="S ", value="S", variable=size_lang_var)
        btn_size1.select()  # 기본값 선택
        btn_size2 = Radiobutton(pants_donate, text="M", value="M", variable=size_lang_var)
        btn_size3 = Radiobutton(pants_donate, text="L ", value="L", variable=size_lang_var)
        ...
        # size 버튼
        size_btn = Button(pants_donate)  # root라는 창에 버튼 생성
        ...
        # size 선택되었음 대기
        size_lb = Label(pants_donate)  # root라는 창에 레이블 생성
        size_lb.place(x=670, y=225)  # 레이블 배치

        # gender 라디오
        gender_lang_var = StringVar()  # str 형으로 변수 저장
        btn_gender1 = Radiobutton(pants_donate, text="남", value="남", variable=gender_lang_var)
        btn_gender1.select()  # 기본값 선택
        btn_gender2 = Radiobutton(pants_donate, text="여", value="여", variable=gender_lang_var)
        ...
        # gender 버튼
        gender_btn = Button(pants_donate)  # root라는 창에 버튼 생성
        ...
        # gender 선택되었음 대기
        gender_lb = Label(pants_donate)  # root라는 창에 레이블 생성
        gender_lb.place(x=670, y=320)  # 레이블 배치

        # defect 라디오
        defect_lang_var = StringVar()  # str 형으로 변수 저장
        btn_defect1 = Radiobutton(pants_donate, text="약 ", value="약", variable=defect_lang_var)
        btn_defect1.select()  # 기본값 선택
        btn_defect2 = Radiobutton(pants_donate, text="중", value="중", variable=defect_lang_var)
        btn_defect3 = Radiobutton(pants_donate, text="강", value="강", variable=defect_lang_var)
        ...
        # defect 버튼
        defect_btn = Button(pants_donate)  # root라는 창에 버튼 생성
        ...
        # defect 선택되었음 대기
        defect_lb = Label(pants_donate)  # root라는 창에 레이블 생성
        defect_lb.place(x=670, y=405)  # 레이블 배치

        # go_dona 버튼
        self.go_donaButton = tkinter.Button(self.pants_donate, width=268, height=68, borderwidth=0, command=self.T_D_Button)
        ...
        # back 버튼
        self.backButton = tkinter.Button(self.pants_donate, width=130, height=75, borderwidth=0, command=self.BackButton)
    ...
    def BackButton(self):
        DONATE.Donate(self.pants_donate)